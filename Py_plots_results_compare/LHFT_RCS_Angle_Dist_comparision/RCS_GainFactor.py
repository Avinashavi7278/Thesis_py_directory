...
def main():
    ...
    if Object == "plate":
        json_file = 'D:/FAU Notes/4Master_Thesis/Simulation/Python_Directory/Py_plots_results_compare/LHFT_RCS_Angle_Dist_comparision/RCS_Plate_vs_azimuth_elevation.json'
    ...
    if Object == "corner":
        Obj_range = 2
        Oversamp_factor = 30
        json_file = 'D:/FAU Notes/4Master_Thesis/Simulation/Python_Directory/Py_plots_results_compare/LHFT_RCS_Angle_Dist_comparision/RCS_corner_vs_azimuth_elevation.json'
        measurements = load_data(json_file, Obj_range, Oversamp_factor)
