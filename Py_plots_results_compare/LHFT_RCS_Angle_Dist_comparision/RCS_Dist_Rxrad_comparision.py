...
def main():
    ...
    if Object == "plate":
        json_file = 'D:/FAU Notes/4Master_Thesis/Simulation/Python_Directory/Py_plots_results_compare/LHFT_RCS_Angle_Dist_comparision/RCS_plate_dist_Rxantenna.json'
    ...
    if Object == "corner":
        Obj_range = 3
        Oversamp_factor = 90
        json_file = 'D:/FAU Notes/4Master_Thesis/Simulation/Python_Directory/Py_plots_results_compare/LHFT_RCS_Angle_Dist_comparision/RCS_corner_dist_Rxantenna.json'
        measurements = load_data(json_file, Obj_range, Oversamp_factor)
