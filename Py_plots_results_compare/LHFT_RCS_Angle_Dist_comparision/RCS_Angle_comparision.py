...
def main():
    ...
    if Object == "corner":
        json_file = 'D:/FAU Notes/4Master_Thesis/Simulation/Python_Directory/Py_plots_results_compare/LHFT_RCS_Angle_Dist_comparision/RCS_corner_angle_results_auto.json'
        measurements = load_data(json_file)
